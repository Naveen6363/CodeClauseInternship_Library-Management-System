...
#verifying input
        ...
        # label and input box
        label4 = Label(self, text='Add Student Details', fg='blue', font=('Arial', 25, 'bold')).pack()
        ...
        butt=Button(self,text="Browse", bg='green', fg='white', width=7,command=fileDialog).place(x=400,y=328)
        S_phone_number = Entry(self, textvariable=d, width=30).place(x=200, y=282)
        S_butt = Button(self, text="Submit", bg='deeppink', fg='white', width = 15,command=asi).place(x=230, y=390)
